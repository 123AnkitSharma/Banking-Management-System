...
bool modify_customer_info(int connFD)
{
    ...
    writeBytes = write(connFD, "Enter the Customer ID (e.g. 0, 1, 2) of the customer to edit", strlen("Enter the Customer ID (e.g. 0, 1, 2) of the customer to edit"));
...
bool modify_employee_info(int connFD)
{
    ...
    writeBytes = write(connFD, "Enter the Employee ID (e.g. 0, 1, 2) of the employee to edit", strlen("Enter the Employee ID (e.g. 0, 1, 2) of the employee to edit"));
...
bool manage_user_roles(int connFD)
{
    ...
    writeBytes = write(connFD, "Enter the Employee ID (e.g. 0, 1, 2) to promote/demote", strlen("Enter the Employee ID (e.g. 0, 1, 2) to promote/demote"));
